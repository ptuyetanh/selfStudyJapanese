...
class StudyAlphabetMember extends Component {
    componentDidMount() {
                ...
                <div className="content">
                    <div className="studyAlphabet">
                        <div className="container">
                            <Link to={'/seeAlphabetMember/' + params.lesson + '/' + params.id_lesson}
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(StudyAlphabetMember));