    ...
    howToLearn = () => {
        ...
        if (this.props.study.vocabularyData !== null) {
            ...
            switch (numberHowtolearnNow) {
                ...
                case 1:
                    return <ListenAndChoose sound ={studyVocabNow.sound} name = {studyVocabNow.name} vocab_id = {studyVocabNow.vocab_id}/>
                case 2:
                    return <ViewAndWrite />
                default:
                    break;
