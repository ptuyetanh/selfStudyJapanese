...
class StudyCommunicationUser extends Component {
    componentDidMount() {
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(StudyCommunicationUser));